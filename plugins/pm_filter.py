...
async def advantage_spoll_choker(bot, query):
    ...
    await query.answer('Checking for Scenepack in database...')
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('This SCENE PACK Not Found In DataBase')
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"Material Name :{search}  Number of files : {len(files)}  Request ed By : {message.from_user.mention} "
...
async def advantage_spell_chok(msg):
    ...
    gs_parsed = []
    if not g_s:
        k = await msg.reply("I couldn't find any Scenepack in that name.")
